...
class absenteeism_model():
        ...
        def __init__(self, model_file, scaler_file):
            ...
            #joblib.load('model') as model_file,('scaler') as scaler_file:
             with open('model','rb') as model_file, open('scaler', 'rb') as scaler_file:
                self.reg = joblib.load(model_file)
        ...
        def load_and_clean_data(self, data_file):
            ...
            # drop the original absenteeism time and drop the variables we decide we don't need
